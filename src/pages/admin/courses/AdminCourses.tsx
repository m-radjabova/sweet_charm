    ...
    <div className="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="relative h-28 bg-gradient-to-r from-amber-500 to-orange-600 p-4">
        <div className="absolute top-3 right-3 flex items-center gap-2">
          ...
          <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-bold ${course.is_active ? "bg-emerald-500 text-white" : "bg-slate-500 text-white"}`}>
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-bold ${groupsCount > 0 ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}>
        ...
        <div className="flex gap-2 mt-4 pt-3 border-t border-slate-100">
          <Tooltip title="Tahrirlash">
            <button
              onClick={onEdit}
              className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-amber-50 text-amber-700 hover:bg-amber-100 transition-all font-medium text-sm"
            >
          ...
          <Tooltip title="O'chirish">
            <button
              onClick={onDelete}
              className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-rose-50 text-rose-600 hover:bg-rose-100 transition-all font-medium text-sm"
            >
              <HiMiniTrash size={16} />
              O'chirish
            </button>
...
function isCourseUpdated(course: Course) {
...
function normalizeMonthForApi(value: string) {
