...
function Hero() {
  ...
  const buttonClassName =
    "group relative mt-7 inline-flex h-[64px] min-w-[240px] items-center justify-center rounded-[22px] bg-gradient-to-r from-[#F75D86] to-[#F86B87] px-8 text-[18px] font-bold text-[#fff8f1] shadow-[0_13px_22px_rgba(248,107,135,0.22)] transition-all duration-300 hover:-translate-y-[3px] hover:shadow-[0_17px_30px_rgba(248,107,135,0.28)] active:scale-[0.97] sm:mt-10 sm:h-[74px] sm:min-w-[272px] sm:rounded-[24px] sm:px-[34px] sm:text-[19px]";

  return (
    <section
      className="relative min-h-[760px] overflow-hidden bg-cover bg-center px-4 pb-[280px] pt-4 sm:min-h-[860px] sm:px-8 sm:pb-[340px] md:min-h-[940px] lg:min-h-[calc(100svh-90px)] lg:pb-[360px] lg:pt-6"
      style={{
    ...
    >
      ...
      <div className="relative z-20 mx-auto flex max-w-6xl flex-col items-center px-2 text-center sm:px-6">

        <h1
          className={titleClassName}
          style={{
            color: "#68400A",
            fontSize: "clamp(4.8rem, 24vw, 13rem)",
            opacity: 0,
        ...
        <p
          className="max-w-[560px] text-balance text-[16px] leading-[1.3] tracking-[0.01em] text-[var(--color-text-primary)] sm:mt-5 sm:text-[22px]"
          style={{
            opacity: 0,
      ...
      <div className="pointer-events-none absolute inset-0 z-10">
        <HeroIcon
          ...
          alt="Cupcake"
          delay={0.3}
          className="left-[4%] top-[9%] h-[84px] w-[92px] rotate-[-7deg] sm:left-[3%] sm:top-[2%] sm:h-[190px] sm:w-[204px] xl:left-[8%]"
        />
        <HeroIcon
          src={cakeIcon}
          alt="Cake slice"
        ...
        <HeroIcon
          ...
          alt="Rabbit cookie"
          delay={0.7}
          className="left-[6%] top-[56%] h-[86px] w-[92px] rotate-[-6deg] sm:left-[2%] sm:top-[42%] sm:h-[168px] sm:w-[180px] xl:left-[7%]"
        />
        <HeroIcon
          src={cakeIconTwo}
          alt="Cookie"
      ...
      <Sparkle className="left-[18%] top-[8%] text-[24px] text-[var(--color-primary-soft)] sm:left-[10%] sm:top-[12%] sm:text-[28px]" delay={0.5}>✦</Sparkle>
      ...
      <Sparkle className="right-[10%] top-[20%] text-[14px] text-white sm:top-[24%] sm:text-[16px]" delay={1.0}>*</Sparkle>
      ...
      >
        <img
         loading="lazy"
          ...
          className="mx-auto w-[290px] max-w-[78vw] translate-y-[6%] object-contain transition-transform duration-700 hover:scale-[1.03] sm:w-[400px] lg:w-[500px] xl:w-[600px]"
        />
      </div>
